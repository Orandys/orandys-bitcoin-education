...
// Temporary placeholders - replace with actual images
const commodityMoneyImage = '/orandys-logo.png';
const metallicMoneyImage = '/orandys-logo.png';
const paperMoneyImage = '/orandys-logo.png';
import { 
  BookOpen, 
  Play, 
  FileText, 
