    ...
    <>
      {isOpen && (
        <>
          ...
          {/* Menu Content */}
          <div className="fixed top-16 left-0 right-0 bg-white/95 backdrop-blur-xl border-b border-gray-200/50 shadow-lg z-50 lg:hidden">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="text-left">
                          <div className="font-medium text-sm">{getShortTitle(section.title)}</div>
